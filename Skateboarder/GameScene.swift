...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func setupLabels() {
        ...
        scoreTextLabel.position = CGPoint(x: 20.0, y: frame.size.height - 40.0)
        ...
        highScoreTextLabel.position = CGPoint(x: frame.size.width - 20.0, y: frame.size.height - 40.0)
    ...
    func gameOver() {
        ...
        let menuBackgrounColor = UIColor.black.withAlphaComponent(0.4)
        let menuLayer = MenuLayer(color: menuBackgrounColor, size: frame.size)
